...
![F20 District Feature Importance](../archive/figures/classification/F20_district_feature_importance.png)
...
- [F16 District Persona Bridge Map](../archive/figures/classification/F16_district_persona_bridge_map.png)
- [F17 University Persona Fingerprint](../archive/figures/classification/F17_university_persona_fingerprint.png)
- [F21 Top 20 District Persona Fingerprint](../archive/figures/classification/F21_top20_district_persona_fingerprint.png)
- [F18 Persona Share by Score Decile](../archive/figures/classification/F18_persona_score_decile_heatmap.png)
- [F19 SNU Persona Interpretation Card](../archive/figures/classification/F19_snu_persona_interpretation_card.png)
- [F20 District Feature Importance](../archive/figures/classification/F20_district_feature_importance.png)
...
- 상권 스크립트: `scripts/06_classification/17_districts.py`, `18_district_advanced.py`, `19_district_final.py`, `21_district_feature_importance.py`
- 상권-persona bridge 스크립트: `scripts/06_classification/20_district_persona_bridge.py`
- 신뢰성 스크립트: `scripts/06_classification/15_trust_metrics.py`, `16_metric_curves.py`
- 주요 산출물: `reports/generated/classification/outputs/district_*.csv`, `district_feature_importance.csv`, `district_persona_*.csv`, `top20_district_persona.csv`, `trust_metrics.csv`, `operating_table.csv`
- 모델: `reports/generated/classification/models/pu_district.joblib`
- 보존 로그: `reports/archive/classification/logs/DISTRICT_REPORT.md`, `DISTRICT_FEATURE_IMPORTANCE_REPORT.md`, `TRUST_LOG.md`, `PERSONA_BRIDGE_REPORT.md`
