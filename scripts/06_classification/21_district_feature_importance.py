...
def save_outputs(result: pd.DataFrame) -> None:
    output_path = CLASSIFICATION_OUTPUT_DIR / "district_feature_importance.csv"
...
def make_figure(result: pd.DataFrame) -> Path:
    ...
    figure_path = CLASSIFICATION_FIGURE_DIR / "F20_district_feature_importance.png"
...
def write_log(
    ...
    log_text = "\n".join(lines)
    log_path = CLASSIFICATION_LOG_DIR / "DISTRICT_FEATURE_IMPORTANCE_REPORT.md"
...
def validate_outputs() -> None:
    required = [
        CLASSIFICATION_OUTPUT_DIR / "district_feature_importance.csv",
        CLASSIFICATION_FIGURE_DIR / "F20_district_feature_importance.png",
        CLASSIFICATION_LOG_DIR / "DISTRICT_FEATURE_IMPORTANCE_REPORT.md",
